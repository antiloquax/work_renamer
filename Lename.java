/* 
"Lename.java" by Mark Tranter (tranter.m@sky.com).
Linux version.
...
public class Lename {
	public static void main(String[] args) {
		...
		for (File myFile: dir.listFiles()){
			...
			// Copy to "C Sent".
			try{
				copyFile(myFile, new File(myPath + "CSent/" + f));
			}catch(IOException e){
				e.printStackTrace();
			}
			// Rename file.
			renameFile(myFile, new File(myPath + "CToSend/" + newF));
                }
